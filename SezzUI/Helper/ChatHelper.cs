...
// https://github.com/Caraxi/SimpleTweaksPlugin/blob/main/Utility/ChatHelper.cs
...
public static class ChatHelper {
    ...
    static ChatHelper() {
        if (Services.SigScanner.TryScanText(Signatures.SendChat, out var processChatBoxPtr)) {
            ProcessChatBox = Marshal.GetDelegateForFunctionPointer<ProcessChatBoxDelegate>(processChatBoxPtr);
        }

        unsafe {
            if (Services.SigScanner.TryScanText(Signatures.SanitiseString, out var sanitisePtr)) {
