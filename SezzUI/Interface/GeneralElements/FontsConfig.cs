...
namespace SezzUI.Interface.GeneralElements
{
    ...
    public class FontsConfig : PluginConfigObject
    {
        ...
        [JsonIgnore] public static readonly List<string> DefaultFontsKeys = new List<string>() { "MyriadProLightCond_24", "MyriadProLightCond_20", "MyriadProLightCond_18", "MyriadProLightCond_16", "MyriadProLightCond_14", "MyriadProLightCond_12" };
        [JsonIgnore] public static string DefaultBigFontKey => DefaultFontsKeys[0];
        [JsonIgnore] public static string DefaultMediumFontKey => DefaultFontsKeys[2];
        [JsonIgnore] public static string DefaultSmallFontKey => DefaultFontsKeys[4];
