...
public sealed class WHM : BasePreset
{
	...
	{
		Bar bar1 = new(hud);
		bar1.Add(new(bar1) {TextureActionId = 121, TextureActionAdjust = true, StatusIds = new[] {121u, 1871u}, MaxStatusDuration = 30, StatusTarget = Unit.Target}); // Aero
		...
		bar2.Add(new(bar2) {TextureActionId = 25862, CooldownActionId = 25862, Level = 90, StatusId = 2709, MaxStatusDuration = 20}); // Liturgy of the Bell
		hud.AddBar(bar2);
