			...
			switch (DelvUI.Helpers.JobsHelper.RoleForJob(JobId))
			{
				...
				case DelvUI.Helpers.JobRoles.Healer:
					using (Bar bar = new())
					{
						...
						bar.Add(new Icon(bar) { TextureActionId = 7559, CooldownActionId = 7559, StatusId = 160, MaxStatusDuration = 6, StatusTarget = Enums.Unit.Player, Level = 44 }); // Surecast
						hud.AddBar(bar);
					}
					break;
				...
				case DelvUI.Helpers.JobRoles.DPSMelee:
					...
					{
						bar.IconSize = new Vector2(38, 26);
						bar.Add(new Icon(bar) { TextureActionId = 7863, CooldownActionId = 7863, StatusId = 2, MaxStatusDuration = 3, StatusTarget = Enums.Unit.Target, Level = 10 }); // Leg Sweep
						bar.Add(new Icon(bar) { TextureActionId = 7542, CooldownActionId = 7542, StatusId = 84, MaxStatusDuration = 20, StatusTarget = Enums.Unit.Player, Level = 12 }); // Bloodbath
				...
				case DelvUI.Helpers.JobRoles.DPSRanged:
					...
					{
						bar.IconSize = new Vector2(38, 26);
						bar.Add(new Icon(bar) { TextureActionId = 7551, CooldownActionId = 7551, Level = 24 }); // Head Gaze
						bar.Add(new Icon(bar) { TextureActionId = 7541, CooldownActionId = 7541, Level = 8 }); // Second Wind
						bar.Add(new Icon(bar) { TextureActionId = 7548, CooldownActionId = 7548, StatusId = 1209, MaxStatusDuration = 6, StatusTarget = Enums.Unit.Player, Level = 32 }); // Arm's Length
						hud.AddBar(bar);
					}
