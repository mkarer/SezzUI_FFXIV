        ...
        public virtual void Configure(JobHud hud)
        {
            ...
            switch (DelvUI.Helpers.JobsHelper.RoleForJob(JobId))
            {
                case DelvUI.Helpers.JobRoles.Tank:
                    ...
                    barTankRole.Add(new Icon(barTankRole) { TextureActionId = 7548, CooldownActionId = 7548, StatusId = 1209, MaxStatusDuration = 6, StatusTarget = Enums.Unit.Player }); // Arm's Length
                ...
                case DelvUI.Helpers.JobRoles.Healer:
                    ...
                    barHealerRole.Add(new Icon(barHealerRole) { TextureActionId = 7561, CooldownActionId = 7561, StatusId = 167, MaxStatusDuration = 10, StatusTarget = Enums.Unit.Player }); // Swiftcast
                    barHealerRole.Add(new Icon(barHealerRole) { TextureActionId = 7562, CooldownActionId = 7562, StatusId = 1204, MaxStatusDuration = 21, StatusTarget = Enums.Unit.Player }); // Lucid Dreaming
                    barHealerRole.Add(new Icon(barHealerRole) { TextureActionId = 7571, CooldownActionId = 7571, RequiresCombat = true }); // Rescue
                    barHealerRole.Add(new Icon(barHealerRole) { TextureActionId = 7559, CooldownActionId = 7559, StatusId = 160, MaxStatusDuration = 6, StatusTarget = Enums.Unit.Player, IconClipOffset = 0.8f }); // Surecast
                ...
                case DelvUI.Helpers.JobRoles.DPSMelee:
                    ...
                    barDPSMeleeRole.Add(new Icon(barDPSMeleeRole) { TextureActionId = 7542, CooldownActionId = 7542, StatusId = 84, MaxStatusDuration = 20, StatusTarget = Enums.Unit.Player, IconClipOffset = 0.7f }); // Bloodbath
                    barDPSMeleeRole.Add(new Icon(barDPSMeleeRole) { TextureActionId = 7541, CooldownActionId = 7541 }); // Second Wind
                    barDPSMeleeRole.Add(new Icon(barDPSMeleeRole) { TextureActionId = 7548, CooldownActionId = 7548, StatusId = 1209, MaxStatusDuration = 6, StatusTarget = Enums.Unit.Player }); // Arm's Length
                ...
                case DelvUI.Helpers.JobRoles.DPSRanged:
                    ...
                    barDPSRangedRole.Add(new Icon(barDPSRangedRole) { TextureActionId = 7548, CooldownActionId = 7548, StatusId = 1209, MaxStatusDuration = 6, StatusTarget = Enums.Unit.Player }); // Arm's Length
                ...
                case DelvUI.Helpers.JobRoles.DPSCaster:
                    ...
                    barDPSCasterRole.Add(new Icon(barDPSCasterRole) { TextureActionId = 7561, CooldownActionId = 7561, StatusId = 167, MaxStatusDuration = 10, StatusTarget = Enums.Unit.Player }); // Swiftcast
                    barDPSCasterRole.Add(new Icon(barDPSCasterRole) { TextureActionId = 7559, CooldownActionId = 7559, StatusId = 160, MaxStatusDuration = 6, StatusTarget = Enums.Unit.Player, IconClipOffset = 0.8f }); // Surecast
