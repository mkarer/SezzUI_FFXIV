...
namespace SezzUI.Modules.JobHud.Jobs
{
	public sealed class WAR : BasePreset
	{
		...
		public override void Configure(JobHud hud)
		{
			...
			bar1.Add(new(bar1) {TextureActionId = 38, CooldownActionId = 38, StatusActionId = 38, MaxStatusDuration = 15, GlowBorderStatusIds = new[] {(uint) 1177, (uint) 9}, Features = IconFeatures.GlowIgnoresState}); // Berserk
			...
			bar1.Add(new(bar1) {TextureActionId = 3551, CooldownActionId = 3551, StatusIds = new[] {(uint) 735, (uint) 1857}, MaxStatusDuration = jobLevel >= 82 ? 8 : 6}); // Raw Intuition/Nascent Flash
			hud.AddBar(bar1);
			...
			bar2.Add(new(bar2) {TextureActionId = 7388, CooldownActionId = 7388, StatusId = 1457, MaxStatusDuration = 15, GlowBorderStatusIds = new[] {(uint) 87, (uint) 89, (uint) 735}}); // Shake It Off
