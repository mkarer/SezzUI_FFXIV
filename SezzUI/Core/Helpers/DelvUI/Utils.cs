...
namespace DelvUI.Helpers
{
    internal static class Utils
    {
        ...
        public static GameObject? GetBuddy(uint ownerId, BattleNpcSubKind kind)
        {
            ...
            {
                var gameObject = SezzUI.Plugin.ObjectTable[i];
        ...
        public static GameObject? GetGameObjectByName(string name)
        {
            ...
            {
                GameObject? gameObject = SezzUI.Plugin.ObjectTable[i];
        ...
        {
            PlayerCharacter? player = SezzUI.Plugin.ClientState.LocalPlayer;
