...
namespace DelvUI.Helpers
{
    public class LastUsedCast
    {
        ...
        {
            var target = SezzUI.Plugin.TargetManager.SoftTarget ?? SezzUI.Plugin.TargetManager.Target;
            ...
            switch (ActionType)
            {
                ...
                case ActionType.Ability:
                    var action = SezzUI.Plugin.DataManager.GetExcelSheet<Action>()?.GetRow(CastId);
                ...
                case ActionType.Mount:
                    var mount = SezzUI.Plugin.DataManager.GetExcelSheet<Mount>()?.GetRow(CastId);
                ...
                case ActionType.Item:
                    var item = SezzUI.Plugin.DataManager.GetExcelSheet<Item>()?.GetRow(CastId);
                ...
                case ActionType.Companion:
                    var companion = SezzUI.Plugin.DataManager.GetExcelSheet<Companion>()?.GetRow(CastId);
