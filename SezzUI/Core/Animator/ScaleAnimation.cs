...
namespace SezzUI.Animator
{
	...
	public class ScaleAnimation : BaseAnimation
	{
		...
		private ScalingType _defaultType;
		private ScalingType _currentType; // TODO: Use for reversing animation?
		...
		public override void Update()
		{
			if (_isPlaying && _ticksStart != null && Data != null)
			{
				...
				if (timeElapsed > StartDelay && timeElapsed <= StartDelay + Duration)
				{
					...
					float scaleProgress = Math.Min(1, Math.Max(0, (float)timeElapsedAnimating / (float)Duration));
